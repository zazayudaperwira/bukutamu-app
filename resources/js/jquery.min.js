 ...
 * http://jqueryui.com
 * Includes: widget.js, position.js, data.js, disable-selection.js, effect.js, effects/effect-blind.js, effects/effect-bounce.js, effects/effect-clip.js, effects/effect-drop.js, effects/effect-explode.js, effects/effect-fade.js, effects/effect-fold.js, effects/effect-highlight.js, effects/effect-puff.js, effects/effect-pulsate.js, effects/effect-scale.js, effects/effect-shake.js, effects/effect-size.js, effects/effect-slide.js, effects/effect-transfer.js, focusable.js, form-reset-mixin.js, jquery-1-7.js, keycode.js, labels.js, scroll-parent.js, tabbable.js, unique-id.js, widgets/accordion.js, widgets/autocomplete.js, widgets/button.js, widgets/checkboxradio.js, widgets/controlgroup.js, widgets/datepicker.js, widgets/dialog.js, widgets/draggable.js, widgets/droppable.js, widgets/menu.js, widgets/touch.js, widgets/progressbar.js, widgets/resizable.js, widgets/selectable.js, widgets/selectmenu.js, widgets/slider.js, widgets/sortable.js, widgets/spinner.js, widgets/tabs.js, widgets/tooltip.js
...
(function (t) {
    ...
    t.uiBackCompat !== !1 &&
        ...
        t.widget("ui.menu", {
            ...
            _create: function () {
                (this.activeMenu = this.element),
                    ...
                    this._on({
                        "touchdown .ui-menu-item": function (t) {
                            t.preventDefault();
                        },
                        ...
                        "touchenter .ui-menu-item": function (e) {
                        ...
                        touchleave: "collapseAll",
                        "touchleave .ui-menu": "collapseAll",
                        focus: function (t, e) {
                            var i =
                                this.active ||
        ...
        t.widget("ui.autocomplete", {
                    ...
                    this._on(this.menu.element, {
                        ...
                        menufocus: function (e, i) {
                            ...
                            return this.isNewMenu &&
                                ((this.isNewMenu = !1),
                                e.originalEvent &&
                                    /^touch/.test(e.originalEvent.type))
                                ? (this.menu.blur(),
            ...
            _close: function (t) {
                this._off(this.document, "touchdown"),
                    this.menu.element.is(":visible") &&
            ...
            _suggest: function (e) {
                ...
                this._renderMenu(i, e),
                    ...
                    this._on(this.document, {
                        touchdown: "_closeOnClickOutside",
                    });
            },
    ...
    t.extend(s.prototype, {
        ...
        (t.fn.datepicker = function (e) {
            ...
            t.datepicker.initialized ||
                (t(document).on("touchdown", t.datepicker._checkExternalClick),
    ...
    var _ = !1;
    t(document).on("touchup", function () {
        _ = !1;
    }),
        t.widget("ui.touch", {
            version: "1.12.1",
            ...
            _touchInit: function () {
                var e = this;
                this.element
                    .on("touchdown." + this.widgetName, function (t) {
                        return e._touchDown(t);
                    })
            ...
            _touchDestroy: function () {
                this.element.off("." + this.widgetName),
                    this._touchMoveDelegate &&
                        this.document
                            .off(
                                "touchmove." + this.widgetName,
                                this._touchMoveDelegate
                            )
                            .off(
                                "touchup." + this.widgetName,
                                this._touchUpDelegate
                            );
            },
            _touchDown: function (e) {
                if (!_) {
                    (this._touchMoved = !1),
                        this._touchStarted && this._touchUp(e),
                        (this._touchDownEvent = e);
                    var i = this,
                        s = 1 === e.which,
                        n =
                            ...
                            e.target.nodeName
                                ? t(e.target).closest(this.options.cancel)
                                      .length
                                : !1;
                    return s && !n && this._touchCapture(e)
                        ? ((this.touchDelayMet = !this.options.delay),
                          this.touchDelayMet ||
                              (this._touchDelayTimer = setTimeout(function () {
                                  i.touchDelayMet = !0;
                              }, this.options.delay)),
                          this._touchDistanceMet(e) &&
                          this._touchDelayMet(e) &&
                          ((this._touchStarted = this._touchStart(e) !== !1),
                          !this._touchStarted)
                              ? (e.preventDefault(), !0)
                              : (!0 ===
                                    t.data(
                                ...
                                (this._touchMoveDelegate = function (t) {
                                    return i._touchMove(t);
                                }),
                                (this._touchUpDelegate = function (t) {
                                    return i._touchUp(t);
                                }),
                                this.document
                                    .on(
            ...
            _touchMove: function (e) {
                ...
                return (
                    (e.which || e.button) && (this._touchMoved = !0),
                    this._touchStarted
                        ? (this._touchDrag(e), e.preventDefault())
                        : (this._touchDistanceMet(e) &&
                              this._touchDelayMet(e) &&
                              ((this._touchStarted =
                                  this._touchStart(this._touchDownEvent, e) !==
                                  !1),
                              this._touchStarted
                                  ? this._touchDrag(e)
                                  : this._touchUp(e)),
            ...
            _touchUp: function (e) {
                this.document
                    ...
                    .off("touchup." + this.widgetName, this._touchUpDelegate),
                    this._touchStarted &&
                        ((this._touchStarted = !1),
                        e.target === this._touchDownEvent.target &&
                            t.data(
                                e.target,
                                this.widgetName + ".preventClickEvent",
                                !0
                        ...
                        this._touchStop(e)),
                    this._touchDelayTimer &&
                        (clearTimeout(this._touchDelayTimer),
                        delete this._touchDelayTimer),
                    (this.ignoreMissingWhich = !1),
                    (_ = !1),
                    e.preventDefault();
            },
            _touchDistanceMet: function (t) {
                return (
                    Math.max(
                        Math.abs(this._touchDownEvent.pageX - t.pageX),
                        Math.abs(this._touchDownEvent.pageY - t.pageY)
                    ) >= this.options.distance
                );
            },
            _touchDelayMet: function () {
                return this.touchDelayMet;
            },
            _touchStart: function () {},
            _touchDrag: function () {},
            _touchStop: function () {},
            _touchCapture: function () {
                return !0;
            },
        }),
        (t.ui.plugin = {
        ...
        t.widget("ui.draggable", t.ui.touch, {
            version: "1.12.1",
            ...
            _touchDrag: function (e, i) {
                if (
                    ...
                    if (this._trigger("drag", e, s) === !1)
                        return this._touchUp(new t.Event("touchup", e)), !1;
            ...
            _touchUp: function (e) {
                return (
                    ...
                    this.handleElement.is(e.target) &&
                        this.element.trigger("focus"),
                    t.ui.touch.prototype._touchUp.call(this, e)
                );
            },
            cancel: function () {
                return (
                    ...
                    (o.positionAbs = s.positionAbs),
                        ...
                        n
                            ? (o.isOver ||
                                  ...
                                  (o.fromOutside = s)),
                              o.currentItem &&
                                  (o._touchDrag(e), (i.position = o.position)))
                            : o.isOver &&
                              ((o.isOver = 0),
        ...
        t.ui.draggable,
        t.widget("ui.resizable", t.ui.touch, {
            version: "1.12.1",
            ...
            _setupHandles: function () {
                ...
                (this._renderAxis = function (e) {
                    ...
                    this._handles.on("touchover", function () {
                        r.resizing ||
                            (this.className &&
            ...
            _createOverlay: function () {
                if (this.options.modal) {
                    ...
                    this._delay(function () {
                        ...
                        this._on(this.overlay, { touchdown: "_keepFocus" }),
                        this.document.data(
                            "ui-dialog-overlays",
    ...
    (t.ui.ddmanager = {
            ...
            t: for (s = 0; o.length > s; s++)
                if (
                    ...
                    (o[s].visible = "none" !== o[s].element.css("display")),
                        o[s].visible &&
                            ("touchdown" === a && o[s]._activate.call(o[s], i),
        ...
        t.widget("ui.selectable", t.ui.touch, {
            version: "1.12.1",
            options: {
                appendTo: "body",
                autoRefresh: !0,
                ...
                _drawMenu: function () {
                    ...
                    (this.menu = t("<ul>", {
                        ...
                        (this.menuInstance = this.menu
                            ...
                            .menu("instance")),
                        this.menuInstance._off(this.menu, "touchleave"),
        ...
        t.widget("ui.slider", t.ui.touch, {
            ...
            _touchDrag: function (t) {
                var e = { x: t.pageX, y: t.pageY },
                    i = this._normValueFromtouch(e);
                return this._slide(t, this._handleIndex, i), !1;
            },
            _touchStop: function (t) {
                return (
            ...
            _normValueFromtouch: function (t) {
                var e, i, s, n, o;
                return (
        ...
        t.widget("ui.sortable", t.ui.touch, {
            version: "1.12.1",
            ...
            cancel: function () {
                if (this.dragging) {
                    this._touchUp(new t.Event("touchup", { target: null })),
                        "original" === this.options.helper
        ...
        t.widget("ui.spinner", {
            ...
            _events: {
                ...
                touchwheel: function (t, e) {
                    if (e) {
                        if (!this.spinning && !this._start(t)) return !1;
                        this._spin((e > 0 ? 1 : -1) * this.options.step, t),
                            clearTimeout(this.touchwheelTimer),
                            (this.touchwheelTimer = this._delay(function () {
                                this.spinning && this._stop(t);
                            }, 100)),
                            t.preventDefault();
                    }
                },
                "touchdown .ui-spinner-button": function (e) {
                    function i() {
                        var e =
                            this.element[0] ===
                            t.ui.safeActiveElement(this.document[0]);
                ...
                "touchup .ui-spinner-button": "_stop",
                "touchenter .ui-spinner-button": function (e) {
                ...
                "touchleave .ui-spinner-button": "_stop",
            },
            _enhance: function () {
        ...
        t.widget("ui.tooltip", {
            ...
            _create: function () {
                this._on({ touchover: "open", focusin: "open" }),
                    (this.tooltips = {}),
                    (this.parents = {}),
                    (this.liveRegion = t("<div>")
                        .attr({
            ...
            _open: function (e, i, s) {
                ...
                if (s) {
                    ...
                    i.is("[title]") &&
                        ...
                        this.options.track && e && /^touch/.test(e.type)
                            ? (this._on(this.document, { touchmove: n }), n(e))
                            : a.position(
            ...
            _registerCloseHandlers: function (e, i) {
                ...
                i[0] !== this.element[0] &&
                    ...
                    (e && "touchover" !== e.type) || (s.touchleave = "close"),
                ...
                return o
                    ? ((i = o.tooltip),
                      o.closing ||
                          ...
                          this._off(n, "touchleave focusout keyup"),
                          n[0] !== this.element[0] && this._off(n, "remove"),
                          this._off(this.document, "touchmove"),
                          e &&
                              "touchleave" === e.type &&
