            ...
            <div class=col-4>
                ...
                <div class="card me-2 mt-2 bg-primary">
                    ...
                    <div class="card-body">
                      ...
                      {{-- <p class="card-text">Sistem Buku Tamu untuk kunjungan BPS Provinsi Lampung</p> --}}
                    </div>
            </a>
                </div>
            </div>
...
{{-- SURVEY KEPUASAN DIRECT TO CHECKOUT --}}
            <div class=col-4>
              ...
              <a href="/login" class="text-decoration-none text-white" data-bs-toggle="modal" data-bs-target="#exampleModal">
                <p class="text-dark"> <b>Silahkan Mengisi Survei Kepuasan</b> </p>
                <div class="card me-2 mt-2 bg-primary" >
                    <img src="images/img_2.jpg" class="card-img-top img-fluid">
                    <div class="card-body">
                      <h5 class="card-title">Survei Kepuasan</h5>
                      {{-- <p class="card-text">Untuk Admin dan frontliner BPS Provinsi Lampung<br></p> --}}
                    </div>
                </div>
              </a>
 ...
 <form action="/" method="post">
  @csrf
     <fieldset>
          ...
          <div class="col-3"></div>
              <div class="col-2">
                        <input type="radio" name="tingkatkepuasan" class="form-control sr-only" id="stpuas" value="Tidak Puas">
              ...
              <div class="col-2">
                      <input type="radio" name="tingkatkepuasan" class="form-control sr-only" id="spuas" value="Sangat Puas">
        ...
        {{-- <div class="row mt-2">
            ...
            <div class="col-6">
              <div class="form-group mb-1">
                ...
                <input type="text" name="feedback" id="feedback" class="form-control mt-3" placeholder="Tuliskan saran dan masukan anda disini">
              </div>
            </div>
            <div class="col-3"></div>
        </div> --}}
{{-- 
       <div class="form-group mb-5 mt-5">
          <button type="submit" name="inputKepuasansa" value="inputKepuasan" class="btn btn-outline-primary"> Submit </button>
       </div>
      </form> --}}

   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#ffffff" fill-opacity="1" d="M0,96L40,101.3C80,107,160,117,240,133.3C320,149,400,171,480,176C560,181,640,171,720,138.7C800,107,880,53,960,53.3C1040,53,1120,107,1200,117.3C1280,128,1360,96,1400,80L1440,64L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
